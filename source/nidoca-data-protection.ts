...
export class NidocaDataProtection extends LitElement {
  ...
  getLocalStorageAcceptValue(): boolean {
    let isAcceptedAsNumber = Number(localStorage.getItem(NidocaDataProtection.LOCAL_STORAGE_ACCEPT_KEY));
  ...
  setLocalStorageAcceptValue(acceptValue: boolean): void {
    localStorage.setItem(NidocaDataProtection.LOCAL_STORAGE_ACCEPT_KEY, acceptValue ? '1' : '0');
  }
